 ...
 * @author florence
 */
public class Sprint3_3 extends javax.swing.JFrame {
    ...
    public Sprint3_3(Team team, Project pr) {
        initComponents();
        this.team = team;
        this.pr = pr;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        setVisible(false);
        Sprint3_4 spr = new Sprint3_4(team, pr);
        spr.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sprint3_3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Sprint3_3(team,pr).setVisible(true);
            }
        });
    }
