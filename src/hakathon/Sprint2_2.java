 ...
 * @author florence
 */
public class Sprint2_2 extends javax.swing.JFrame {
    ...
    public Sprint2_2(Team team, Project pr) {
        initComponents();
        this.team = team;
        this.pr = pr;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        setVisible(false);
        Sprint2_3 spr = new Sprint2_3(team, pr);
        spr.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sprint2_2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Sprint2_2(team,pr).setVisible(true);
            }
        });
    }
