 ...
 * @author florence
 */
public class Sprint1_3 extends javax.swing.JFrame {
    ...
    public Sprint1_3(Team team, Project pr) {
        initComponents();
        this.team = team;
        this.pr = pr;
    }
    ...
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
        ...
        ev.sprint(team, pr.initialCustomerSatisfation, 1, 1);
        
    }//GEN-LAST:event_jCheckBox1ActionPerformed

    private void jCheckBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox2ActionPerformed
        // TODO add your handling code here:
        ev.sprint(team, pr.initialCustomerSatisfation, 1, 2);
    }//GEN-LAST:event_jCheckBox2ActionPerformed

    private void jCheckBox3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox3ActionPerformed
        // TODO add your handling code here:
        ev.sprint(team, pr.initialCustomerSatisfation, 1, 3);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        setVisible(false);
        Sprint1_4 spr = new Sprint1_4(team, pr);
        spr.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sprint1_3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Sprint1_3(team, pr).setVisible(true);
            }
        });
    }
