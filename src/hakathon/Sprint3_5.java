 ...
 * @author florence
 */
public class Sprint3_5 extends javax.swing.JFrame {
    ...
    public Sprint3_5(Team team, Project pr) {
        initComponents();
        this.team = team;
        this.pr = pr;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sprint3_5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Sprint3_5(team,pr).setVisible(true);
            }
        });
    }
